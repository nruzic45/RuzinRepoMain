...
global nx, kx, ny, ky, nz, kz, krajL #globalne promenljive za opis iymerenog ubrzanja
kx = 2
nx = 2
ky = 2
ny = 2
...
class App(QWidget):
    ...
    def initUI(self):
        ...
        #Grafik
        #global grafik
        #grafik = PlotCanvas(self, width = 6, height = 5)
        #grafik.move(120, 10)
        #grafik.show()
...
def fun1(): #funkcija koju izvrsavamo u niti pored niti koja se izvrsava za GUI
    ...
    while(True):
        ...
        if krajL == 1:
            ...
            niz = np.arange(1, i, 1)
            #grafik.clear()
            #grafik.plot(x = niz, y = niz, naslov = 'Ubrzanje')
